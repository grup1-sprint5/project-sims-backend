...
<head>
    ...
    <title>Fleetly - Fleet Management System</title>
    ...
    <div class="bg-white dark:bg-gray-900">
        <nav class="w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur shadow-md border-b border-gray-200/20 dark:border-white/10 sticky top-0 z-50">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 flex items-center justify-between h-16">
                <div class="flex items-center gap-2">
                    <img src="/favicon.png" class="h-8 w-auto" alt="Fleetly Logo">
                    <span class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Fleetly</span>
                </div>
                <div>
        ...
        <main>
                ...
                <div class="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-20 items-center">
                    <div class="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
                        <div class="inline-flex space-x-6 mb-6">
                            <span class="rounded-full bg-indigo-600/10 px-3 py-1 text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-indigo-600/10">Sprint 5</span>
                        </div>
                    ...
                    <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:mt-0 lg:mr-0 lg:ml-10 lg:max-w-none lg:flex-none xl:ml-32">
                        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                            <img src="https://tailwindcss.com/plus-assets/img/component-images/project-app-screenshot.png" alt="Fleetly Dashboard" class="w-[48rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="video" class="bg-gray-50 dark:bg-gray-800/50 py-24 sm:py-32">
                <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">See Fleetly in action</h2>
        ...
        <footer class="mx-auto max-w-7xl px-6 lg:px-8 border-t border-gray-200 dark:border-white/10 mt-20">
            <div class="py-12 md:flex md:items-center md:justify-between">
                ...
                <p class="mt-8 text-center text-sm text-gray-500 md:order-1 md:mt-0">&copy; 2026 Fleetly Project Team 1. EUPL Licensed.</p>
            </div>
        </footer>
    </div>
</body>
