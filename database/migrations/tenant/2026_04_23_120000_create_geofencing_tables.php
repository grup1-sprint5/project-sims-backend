...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $this->addPostgisObjectsIfAvailable();
    }

    public function down(): void
    {
        $this->dropPostgisObjectsIfAvailable();
    ...
    private function addPostgisObjectsIfAvailable(): void
    {
    ...
    private function dropPostgisObjectsIfAvailable(): void
    {
        if (DB::getDriverName() !== 'pgsql') {
            return;
        }
        ...
        try {
            DB::statement('DROP INDEX IF EXISTS geofences_geometry_gix');
            DB::statement('DROP INDEX IF EXISTS geofence_events_position_gix');
            DB::statement('ALTER TABLE geofences DROP COLUMN IF EXISTS geometry');
            DB::statement('ALTER TABLE geofence_events DROP COLUMN IF EXISTS position');
        } catch (\Throwable $exception) {
            report($exception);
        }
    }
